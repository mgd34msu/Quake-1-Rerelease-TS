...
export function CL_InitInput(): void {
  Cmd_AddCommand("+moveup", IN_UpDown, "nq");
  Cmd_AddCommand("-moveup", IN_UpUp, "nq");
  Cmd_AddCommand("+movedown", IN_DownDown, "nq");
  Cmd_AddCommand("-movedown", IN_DownUp, "nq");
  Cmd_AddCommand("+left", IN_LeftDown, "nq");
  Cmd_AddCommand("-left", IN_LeftUp, "nq");
  Cmd_AddCommand("+right", IN_RightDown, "nq");
  Cmd_AddCommand("-right", IN_RightUp, "nq");
  Cmd_AddCommand("+forward", IN_ForwardDown, "nq");
  Cmd_AddCommand("-forward", IN_ForwardUp, "nq");
  Cmd_AddCommand("+back", IN_BackDown, "nq");
  Cmd_AddCommand("-back", IN_BackUp, "nq");
  Cmd_AddCommand("+lookup", IN_LookupDown, "nq");
  Cmd_AddCommand("-lookup", IN_LookupUp, "nq");
  Cmd_AddCommand("+lookdown", IN_LookdownDown, "nq");
  Cmd_AddCommand("-lookdown", IN_LookdownUp, "nq");
  Cmd_AddCommand("+strafe", IN_StrafeDown, "nq");
  Cmd_AddCommand("-strafe", IN_StrafeUp, "nq");
  Cmd_AddCommand("+moveleft", IN_MoveleftDown, "nq");
  Cmd_AddCommand("-moveleft", IN_MoveleftUp, "nq");
  Cmd_AddCommand("+moveright", IN_MoverightDown, "nq");
  Cmd_AddCommand("-moveright", IN_MoverightUp, "nq");
  Cmd_AddCommand("+speed", IN_SpeedDown, "nq");
  Cmd_AddCommand("-speed", IN_SpeedUp, "nq");
  Cmd_AddCommand("+attack", IN_AttackDown, "nq");
  Cmd_AddCommand("-attack", IN_AttackUp, "nq");
  Cmd_AddCommand("+use", IN_UseDown, "nq");
  Cmd_AddCommand("-use", IN_UseUp, "nq");
  Cmd_AddCommand("+jump", IN_JumpDown, "nq");
  Cmd_AddCommand("-jump", IN_JumpUp, "nq");
  Cmd_AddCommand("impulse", IN_Impulse, "nq");
  Cmd_AddCommand("+klook", IN_KLookDown, "nq");
  Cmd_AddCommand("-klook", IN_KLookUp, "nq");
  Cmd_AddCommand("+mlook", IN_MLookDown, "nq");
  Cmd_AddCommand("-mlook", IN_MLookUp, "nq");
}
